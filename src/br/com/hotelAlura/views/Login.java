...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        imgHotel.setIcon(new ImageIcon(Login.class.getResource("/images/img-hotel-login-.png")));
        ...
        logo.setIcon(new ImageIcon(Login.class.getResource("/images/lOGO-50PX.png")));
    ...
    private void Login() {
        ...
        if (!Utilitarios.isEmpty(this.txtUsuario.getText()) && !Utilitarios.isEmpty(this.txtSenha.getText())) {
            if (this.loginController.acessar(new br.com.hotelAlura.model.Login(this.txtUsuario.getText(), this.txtSenha.getText()))) {
